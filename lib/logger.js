...
const assertionHasDetails = (assertion) =>
  assertion.error && assertion.error.expected && assertion.error.actual
...
const formatMessage = (name, attributes) => {
...
Logger.prototype.failAssertion = function () {
  const mess = this.assertion.error ? this.assertion.error.message : this.assertion.raw
  const dets = this.assertion.error ? this.assertion.error.raw : this.assertion.raw
